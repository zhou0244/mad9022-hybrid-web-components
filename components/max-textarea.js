...
class MaxTextarea extends HTMLElement {
  #characterCount;
  constructor() {
    super();
    ...
    this.maxInput = this.root.querySelector("textarea");
    ...
    this.maxInput.addEventListener("input", (ev) => {
      ...
      const limit = parseInt(document.querySelector("max-textarea").limit);
  ...
  attributeChangedCallback(attrName, oldVal, newVal) {
    ...
    } else if (attrName.toLowerCase() === "rows") {
      this.maxInput.rows = newVal;
    }
  }
}
